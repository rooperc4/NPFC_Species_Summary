...
# get the historical catch record after 2002 from the NPFC website 
...
# get the historical catch record before 2001 from the FAO statistics
download.file("https://www.npfc.int/system/files/2021-04/NPFC-2021-AR-Annual%20Summary%20Footprint%20-%20Bottom%20Fisheries.xlsx", destfile = "data/NPFC_catch_summary.xlsx", mode = "wb", quiet = FALSE)
## unzip the file
...
FAO_catch <- bind_rows(FAO_catch_Japan, FAO_catch_Russia_and_Korea)

# get the historical catch record before 2001 for Japan from "Historical_catch_NPA_SA_JP.csv" because the catch values of the FAO statistics are incorrect
