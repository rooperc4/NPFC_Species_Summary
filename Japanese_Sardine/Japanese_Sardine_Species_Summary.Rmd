...
```{r picture, fig.cap="Figure 1. Japanese Sardine (*Sardinops melanostictus*).", echo=FALSE}
...
### Life history
Japanese sardine are short-lived and fast growing, maturing early at 2-years old. Their maximum length is ~24 cm and their maximum reported age is 25 years (Whitehead 1985). Their growth rates and spawning patterns are highly influenced by the environment [@Niino2021]
